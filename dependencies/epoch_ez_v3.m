...
% find out stimulus onset time
fixStd_time = find_near_ev([fix_start',fix_end'],gipStd_time); % fixation time, nan if missing % msec
fixDev_time = find_near_ev([fix_start',fix_end'],gipDev_time); % msec
...
t_f_blue = find_1st_fix(fix_start,blue_time);
